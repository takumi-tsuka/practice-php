...
$file = fopen('./data/contactlist.json','r');
$data = fread($file,filesize('./data/contactlist.json'));
fclose($file);
$file = fopen('./data/ivs.dat','r');
$ivdata = fread($file,filesize('./data/ivs.dat'));
...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    fclose($file);
    $file = fopen('./data/contactlist.json','w');
    fwrite($file,$enc);
    fclose($file);
}
?>
